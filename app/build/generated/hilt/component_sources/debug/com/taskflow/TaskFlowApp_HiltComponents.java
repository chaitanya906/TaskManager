...
import com.taskflow.data.worker.TrashCleanupWorker_HiltModule;
import com.taskflow.di.DatabaseModule;
import com.taskflow.di.RepositoryModule;
import com.taskflow.di.UseCaseModule;
import com.taskflow.presentation.MainActivity_GeneratedInjector;
...
public final class TaskFlowApp_HiltComponents {
  private TaskFlowApp_HiltComponents() {
  }
  ...
  @Component(
      modules = {
          ...
          TrashCleanupWorker_HiltModule.class,
          UseCaseModule.class
      }
  )
  @Singleton
  public abstract static class SingletonC implements TaskFlowApp_GeneratedInjector,
